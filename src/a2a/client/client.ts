...
export class A2AClient {
  ...
  async sendTask(params: TaskSendParams): Promise<Task | null> {
    ...
    return (await this._handleJsonResponse<SendTaskResponse>(
      httpResponse,
      "tasks/send"
    )) ?? null;
  }
  ...
  sendTaskSubscribe(
    ...
    const streamGenerator = async function* (
      ...
      if( httpResponse ) {
        ...
        const result = await this._handleStreamingResponse<SendTaskStreamingResponse>(
          httpResponse,
          "tasks/sendSubscribe"
        );
  ...
  async getTask(params: TaskQueryParams): Promise<Task | null> {
    ...
    return (await this._handleJsonResponse<GetTaskResponse>(httpResponse, "tasks/get")) ?? null;
  }
  ...
  async cancelTask(params: TaskIdParams): Promise<Task | null> {
    ...
    return (await this._handleJsonResponse<CancelTaskResponse>(
      httpResponse,
      "tasks/cancel"
    )) ?? null;
  }
  ...
  async setTaskPushNotification(
    ...
    return (await this._handleJsonResponse<SetTaskPushNotificationResponse>(
      httpResponse,
      "tasks/pushNotification/set"
    )) ?? null;
  }
  ...
  async getTaskPushNotification(
    ...
    return (await this._handleJsonResponse<GetTaskPushNotificationResponse>(
      httpResponse,
      "tasks/pushNotification/get"
    )) ?? null;
  }
  ...
  resubscribeTask(
    ...
    const streamGenerator = async function* (
      ...
      const result = this._handleStreamingResponse<SendTaskStreamingResponse>(
        httpResponse,
        "tasks/resubscribe"
      );
